...
def parse_opt():
    ...
    parser.add_argument("--weights", nargs="+", type=str, default=r'D:\yolov5\yolov5-master\runs\train\exp48\weights\best.pt', help="model path or triton URL")
    parser.add_argument("--source", type=str, default=ROOT / "data/images", help="file/dir/URL/glob/screen/0(webcam)")
    parser.add_argument("--data", type=str, default=ROOT / "data/stra.yaml", help="(optional) dataset.yaml path")
